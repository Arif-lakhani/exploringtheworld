...
public class BulletSet {
	...
	public BulletSet(AbstractAndroid android, JumpActivity context){
	...
	private void LevelTHree(AbstractAndroid android, JumpActivity context) {
	...
	private void LevelOne(AbstractAndroid android, JumpActivity context) {
		bulletMap.put(""+1, new Bullet((int)android.LTCoorX+17, (int)android.LTCoorY-10, 0, context));
	...
	private void LevelTwo(AbstractAndroid android, JumpActivity context) {
		bulletMap.put(""+1, new Bullet((int)android.LTCoorX+17, (int)android.LTCoorY-10, 0, context));
	...
	public boolean isTouchBullet(AbstractMonster monster){
		...
		for(String key : bulletMap.keySet()){
			...
			if(xiebian <= 30 * JumpActivity.height_mul){
